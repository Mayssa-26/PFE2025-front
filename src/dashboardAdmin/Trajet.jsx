...
//       script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyDNX04w1kGf_a6P7UkxNYAkjYS57bj_p34&libraries=geometry,directions,places`
//       script.async = true
//       script.defer = true
...
//       // Calcul de la vitesse (si les timestamps sont disponibles)
//       if (prevPos.timestamp && currPos.timestamp) {
//         const timeDiff = (new Date(currPos.timestamp) - new Date(prevPos.timestamp)) / 1000; // en secondes
//         if (timeDiff > 0) {
//           const speed = (distance / 1000) / (timeDiff / 3600); // km/h
//           speedData.push({
//             time: new Date(currPos.timestamp),
//             speed
//           });
...
//             // Géocodage inverse pour obtenir l'adresse (purement illustratif)
...
//       {/* Popup Modal pour le rapport d'activité */}
//       {showActivityReport && (
...
//                   <h4 style={{ fontSize: "16px", marginBottom: "10px", color: "#555" }}>Statistiques de vitesse</h4>
...
//               <div>
//                 <h3 style={{ fontSize: "18px", marginBottom: "15px", color: "#555" }}>Points d'arrêt prolongés (>30min)</h3>
                
//                 {activityStats.extendedStops.length === 0 ? (
//                   <p style={{ padding: "15px", backgroundColor: "#f8f9fa", borderRadius: "6px" }}>Aucun arrêt prolongé détecté</p>
//                 ) : (
...
//                       }}>
//                         <p style={{ fontWeight: "600", marginBottom: "10px", color: "#007bff" }}>Arrêt {index + 1}</p>
//                         <p style={{ marginBottom: "5px" }}><strong>Durée:</strong> {formatDuration(stop.duration)}</p>
//                         <p style={{ marginBottom: "5px" }}><strong>Début:</strong> {formatTime(stop.startTime)}</p>
//                         <p style={{ marginBottom: "5px" }}><strong>Fin:</strong> {formatTime(stop.endTime)}</p>
//                         <p style={{ marginBottom: "5px" }}><strong>Adresse:</strong> {stop.address || "Non disponible"}</p>
//                       </div>
//                     ))}
//                   </div>
//                 )}
...
//         }}
//         title="Voir l'activité du véhicule"
//         onMouseOver={(e) => e.currentTarget.style.transform = 'scale(1.1)'}
//         onMouseOut={(e) => e.currentTarget.style.transform = 'scale(1)'}
//       >
//         {showActivityReport ? '✖' : '➡️'}
//       </button>
