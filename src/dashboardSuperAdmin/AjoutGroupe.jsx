...
export default function GroupeTable() {
  ...
  return (
    <div className={`dashboard-admin ${showEditForm || showAddForm || showArchiveModal ? "blurred" : ""}`}>
      <style>
        {`
          /* CSS Variables aligned with AjoutGroup.css */
          :root {
  ...
  position: relative;
  z-index: 1001; /* Add this to ensure it’s above the blurred main-content */
}
        ...
        <div className="container2">
          ...
          {filteredGroupes.length > 0 && (
            <div className="pagination">
              ...
              <span className="current-page" aria-label="Page actuelle">
