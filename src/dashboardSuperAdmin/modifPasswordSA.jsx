...
const PasswordChangeSA = ({ onCancel }) => {
  ...
  const checkPasswordStrength = (password) => {
    ...
    if (password.length < 6) {
      feedback = "Trop court (minimum 6 caractères)";
    } else {
      ...
      <style>
        {`
          :root {
            ...
            --success鹿gradient: linear-gradient(135deg, rgb(24, 68, 106) 0%, rgb(26, 96, 99) 100%);
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="register-input-group">
                ...
                <span className="input-hint">
                  Minimum 6 caractères avec des lettres, chiffres et symboles
                </span>
